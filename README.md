...
## Running Services
- **Frontend**: Running on [http://localhost:5173/](http://localhost:5173/) (React with TypeScript, Vite, and TailwindCSS)  
- **Backend**: Running on [http://localhost:8000](http://localhost:8000) (FastAPI with MongoDB)
